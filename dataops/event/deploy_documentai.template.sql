...
GRANT DATABASE ROLE SNOWFLAKE.DOCUMENT_INTELLIGENCE_CREATOR TO ROLE {{EVENT_ATTENDEE_ROLE}};
...
GRANT CREATE MODEL ON SCHEMA {{ env.DATAOPS_DATABASE }}.{{ env.DOCUMENT_AI }} TO ROLE {{EVENT_ATTENDEE_ROLE}};
