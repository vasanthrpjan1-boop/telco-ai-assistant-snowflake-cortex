...
PUT file:///{{ env.CI_PROJECT_DIR }}/dataops/event/analyst/stock_price_info.yaml @{{ env.DATAOPS_DATABASE }}.{{ env.DOCUMENT_AI_SCHEMA }}.cortex_analyst auto_compress = false overwrite = true;
